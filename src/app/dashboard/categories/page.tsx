...
import { CustomersFilters } from '@/components/dashboard/categories/categories-filter';
import { CustomersTable } from '@/components/dashboard/categories/categories-table';
  ...
  return (
    <Stack spacing={3}>
      <Stack direction="row" spacing={3}>
        ...
        <div>
          <Button href='http://localhost:3000/dashboard/createcategory' startIcon={<PlusIcon fontSize="var(--icon-fontSize-md)" />} variant="contained">
            Add
          </Button>
        </div>
      </Stack>
