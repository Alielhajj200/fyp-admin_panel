...
export function UpdateWorkoutForm(): React.JSX.Element {
...
const [instructions, setInstructions] = useState<string[]>([]);
  ...
  const workout_name = searchParams.get('id');
...
console.log(formData)
    try {
      ...
      const response = await fetch(`http://192.168.56.1:3007/fyp/workout/update/${workout_name}`, {
        method: 'PATCH',
        headers: {
